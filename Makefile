...
simcoalrej2_1_2source := $(wildcard src/simcoalrej2_1_2/*.cpp)
simcoalrej2_1_2objects := $(patsubst %.cpp,%.o,$(wildcard src/simcoalrej2_1_2/*.cpp))

rej2runsource := $(wildcard code/rej2run/*.cpp)
rej2runobjects := $(patsubst %.cpp,%.o,$(wildcard code/rej2run/*.cpp))
